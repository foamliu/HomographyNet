...
if __name__ == "__main__":
    ...
    # test_image = cv.polylines(test_image, [np.int32(four_points)], True, 255, 3, cv.LINE_AA)
    # warped_image = cv.polylines(warped_image, [np.int32(perturbed_four_points)], True, 255, 3, cv.LINE_AA)
